        ...
        <div class="card y-gradient-cstm text-dark mb-4">
            <div class="card-body fw-bold">
                ...
                <div class="d-flex justify-content-between">
                    <a class="small text-dark stretched-link" href="{{ url('admin&v=staffs') }}">View Details</a>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card b-gradient-cstm text-dark mb-4">
            <div class="card-body fw-bold">
                All Logs
                <div class="d-flex justify-content-between">
                    <a class="small text-dark stretched-link" href="{{ url('admin&v=all_logs') }}">View Logs</a>
