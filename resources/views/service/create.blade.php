...
<div id="layoutSidenav_content" style="background-color: rgb(240,236,236);">
    <main>
        <div class="container-fluid px-4">
            <div class="d">
                <h1 class="mt-4"><a href="{{route('servicetype.adminview')}}" style="color:black; text-decoration:none;">Service Type</a> | <span style="font-size:22px;">Create</span></h1>
            </div>
            <hr style="border:1px solid black;">
            <div class="content-wrap container mb-2">
                <div class="form-wrap p-2">
                    <div class="table-wrap d-flex justify-content-center">
                        <form class="container" action="{{route('servicetype.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="d-lg-flex d-md-flex container">
                                ...
                                <div class="m-1 container">
                                    <div class="input-group mb-1">
                                        ...
                                        <input class="form-control" aria-label="Title" aria-describedby="basic-title" type="text" name="request_type" placeholder="My title.." autocomplete="off" value="{{ old('event-title') }}">
                                    </div>
                                    <textarea id="markdown-editor-container" style="min-height:300px;" class="w-100 form-control mt-1" name="description" autocomplete="off" placeholder="Content..">{{ old('event-content') }}</textarea>
                                    <input class="w-50 btn btn-outline-success mt-2" type="submit" name="create-event" value="Create Service Type">
                                </div>
                            </div>
                        </form>
                    </div>
