...
<div id="layoutSidenav_content" style="background-color: rgb(240,236,236);">
    <main>
        <div class="container-fluid px-4">
            <div class="d">
                <h1 class="mt-4">Content Management System | <span style="font-size:22px;">CMS-General</span></h1>
            </div>
        ...
        <form id="generalForm" action="{{ route('cms-general.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <span style="color:red">The function for primary color, background and text were currently disabled.</span>
...
<div class="row">
    ...
    <div class="container">
        ...
        <div class="mt-3 mb-5 mx-1 col-md-2 d-flex justify-content-end" style="float: right;">
            <button type="submit"  class="btn btn-primary btn-lg rounded-pill" id="saveGeneralChanges" onclick="save_page_change()" value="">Save changes</button>
        </div>
        </form>
    </div>
    ...
    <div class=" container col-md-2">
        <label></label>
        <a class="btn btn-outline-primary" type="button" onclick="new_logo();">Upload Logo</a>
    </div>
    <div class="border mt-1 form-wrap p-2">
        <h4>Home header background</h4>
        <button type="button" class="btn btn-sm btn-outline-primary rounded-pill" onclick="new_image();">
            ...
            <div class="row w-100">
                @foreach($homeimgs as $data)
                    ...
                    <section class="m-2 image col-md-4 position-relative d-flex">
                        <button type="button" class="position-absolute badge rounded w-25 h-25 btn btn-danger" onclick="del_imgz('{{ $item_id }}');">
    ...
    <div class="container mt-2 border">
        ...
        <button type="button" class="mb-2 btn btn-sm rounded-pill btn-outline-primary"  type="button" onclick="create_head_btn();">Add new button</button>
        <div class="row">
            <div class="col-md-12">
                            ...
                            @foreach($headerBtns as $h_btns)
                                ...
                                <tr>
                                    ...
                                    <td style="width:100px;">
                                        <button type="button" class="mx-1 btn btn-sm btn-outline-danger" onclick="delete_headerbtn('head_btn', '{{ $h_btns['id'] }}');"><i class="fas fa-trash-alt"></i></button>
    ...
    <div class="mt-3">
        <h3>Cards</h3>
        <hr>
        <button type="button" class="mb-2 btn btn-sm rounded-pill btn-outline-primary"  type="button" onclick="new_card();">Add new card</button>
        <div class="row">
            <div class="col-md-12">
                        ...
                        <tbody>
                            @foreach($homecards as $cdata)
                                ...
                                <tr>
                                    ...
                                    <td style="width:100px;">
                                        <button type="button" class="mx-1 btn btn-sm btn-outline-danger" onclick="delete_headercards('cardz', '{{ $id }}');"><i class="fas fa-trash-alt"></i> Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="mt-3">
            <h3>Footer</h3>
            <hr>
            <button type="button" class="mb-2 btn btn-sm rounded-pill btn-outline-primary" onclick="create_footer_btn();">Add new link</button>
            <div class="row">
                <div class="col-md-12">
                    <div class="table-div shadow" style="overflow: scroll;">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach($footers as $fdata)
                                    <tr>
                                        ...
                                        <td style="width:100px;">
                                            <button type="button" class="mx-1 btn btn-sm btn-outline-danger" onclick="delete_footerlinkz('cardz', '{{ $fdata->id }}');">
