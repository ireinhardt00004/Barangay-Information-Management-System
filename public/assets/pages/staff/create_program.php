...
if(isset($_POST['create-event'])){
    ...
    $conn = $GLOBALS['conn'];
    $sql = $conn->prepare("INSERT INTO `programs`(cover, title, content, program_date) VALUES(:cover,:title,:content, :pd);");
    $sql->bindParam(":cover",$cover);
    $sql->bindParam(":title",$title);
    $sql->bindParam(":content",$content);
    $sql->bindParam(":pd",$pd);
    $sql->execute();
    act_logger("Added new program with title '$title2' ", $current_uri);
            ...
            <form class="container" method="POST" enctype="multipart/form-data">
                <div class="d-lg-flex d-md-flex container">
                    <div class="text-center">
                        <img class="rounded w-100" id="prev-img-event" height="250px" src="../assets/imgs_uploads/bg-img1.png">
                    ...
                    <div class="m-1 container ">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input class="form-control" type="date" name="program-date"  autocomplete="off" required>
                        </div>
