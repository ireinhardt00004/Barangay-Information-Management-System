...
<div class="content-wrap container mb-2">
    <div class="form-wrap p-2">
        <h2>Announcement</h2>
        <a href="<?=$c_role;?>&v=create_announcement" class="btn btn-sm btn-outline-primary rounded-pill mb-2">
...
?>
                    <tr id="<?=$id;?>">
                        ...
                        <td><?=$name;?></td>
                        <td><?=$desc;?></td>
                        <td><a class="btn btn-outline-primary w-100" href="<?=$c_role;?>&v=edit_announcement&id=<?=$id;?>">Edit</a></td>
                        <!-- <td><a class="btn btn-outline-warning w-100" href="'.$url.'">Reset</a></td> -->
                        <td><a class="btn btn-outline-danger w-100" onclick="delete_l('announcement','<?=$id?>');">Delete</a></td>
                    </tr>
<?php }?>
                </tbody>
            </table>
