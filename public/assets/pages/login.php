...
if(isset($_POST['resetpasswd'])){
    ...
    email_reset_password(2, $hash_verif, $email);
}
...
if(isset($_POST['register'])){
    ...
    $ip = $_SERVER['REMOTE_ADDR'];
    $uid = gen_uid();
    $status = create_user(3, $uid, $fn, $ln, $mn, $email, $pass,'aW1nMS5wbmc=');
    if($status === True){
        $isValid = True;
        login(3,$email, $pass, $ip);
    }elseif($status === "EmailExist"){
        $_SESSION['err'] = "toast('[Error]: Email already exist!','2000','rgb(255,0,0,0.3)');";
    }else{
        echo "err";
    }
}
                ...
                <div class="w-100">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="r-login-title">
                            <h2 class="ms-2"><b>Barangay Resident<b></h2>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center mt-3">
                        <form id="login-form" method="POST" class="cstm-form">
                            ...
                            <div class="mt-4 d-flex flex-row text-center">
                                <a id="forgot-password-link" class="mx-auto" href="#" onclick="forgot_passwd();">Forgot password?</a>
                                <a href="#" id="register-link" class="mx-auto">Register</a>
                            </div>
                        </form>
                        <form id="register-form" method="POST" class="cstm-form" style="display: none;">
                            <div class="cstm-ph-form">
                            ...
                            <!-- <small class="mx-3 text-muted">password must have atleast 8 characters*</small> -->
                            <div class="s-c-box d-flex align-items-center justify-content-center">
