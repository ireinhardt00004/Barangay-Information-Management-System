...
foreach($user_datas as $data){
    ...
    $ut = 1;
    $uid = $data['uid'];
    // The Removed edit btn <button class="mx-1 btn btn-sm btn-outline-warning act-btn" onclick="edit_user(\''.$fn.'\',\''.$ln.'\',\''.$mn.'\',\''.$email.'\',\''.$ut.'\',\''.$uid.'\');"><i class="fas fa-edit"></i></button>
